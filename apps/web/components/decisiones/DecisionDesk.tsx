...
function Opportunity({ opportunity: o, account, currency }: { opportunity: DecisionOpportunity; account: string; currency: string }) {
  ...
  return <article className="rounded-2xl border bg-surface p-5">
    ...
    <details className="text-xs text-muted"><summary className="cursor-pointer">Ver evidencia · {o.reading.available}/7 días</summary><p className="mt-2">{o.explanation}</p><p className="mt-2">{o.reading.from} a {o.reading.to} · Actualización más antigua: {o.reading.fetchedAt ?? "No verificable"}.</p></details>
