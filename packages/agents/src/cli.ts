...
if (cmd === "collector") {
  ...
  console.error("uso: tsx src/cli.ts collector [--accounts=id,id] [--days=90] [--shopifyDays=14] [--trigger=schedule|manual] | regroup [--accounts=id,id] [--since=ISO]"); process.exit(1);
}
